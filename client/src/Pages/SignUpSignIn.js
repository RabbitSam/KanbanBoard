                ...
                <div className="sign-form text-center w-100 m-auto">
                    <form onSubmit={onSubmit} className="needs-validation" noValidate>
                        ...
                        <div className="form-floating">
                            <input type="email" id="email-address" className="form-control first-input" placeholder="name@example.com" value={user.email} onChange={e => onFormChange(e, "email")} required/>
                            <label htmlFor="email-address">Email Address</label>
                        </div>
                        <div className="input-group">
                            <div className="form-floating">
                                <input type={showPassword ? "text" : "password"} id="input-password" className="form-control last-input" placeholder="..." value={user.password} onChange={e => onFormChange(e, "password")} required/>
                        ...
                        <button type="submit" className="w-100 btn btn-primary my-3" >
                            {isQuerying ? (
            ...
            <div className="d-flex bg-light" style={{alignItems: "center", height: "100vh"}}>
                <div className="sign-form text-center w-100 m-auto">
                    <form onSubmit={onSubmit} className="needs-validation" noValidate>
                        ...
                        <div className="form-floating">
                            <input type={showPassword ? "text" : "password"} id="confirm-password" className="form-control last-input" placeholder="..." value={user.confirmPassword} onChange={e => onFormChange(e, "confirmPassword")} required/>
